...
class AppConst{
  ...
  static const Color kGrayDk = Color(0xFF707070);
  static const Color kGrayLight = Color(0xFF667781);
  ...
  static const Color kGrayBk = Color(0xFF202c33);

  static double kWidht = 375.w;
  static double kHight = 825.h;
